...
export function TodoPanel({ projectId, onCollapse }: TodoPanelProps) {
  ...
  return (
    <div className="flex h-full flex-col glass-bg" style={{ background: "transparent", borderRight: "1px solid var(--ide-border)", width: "220px", minWidth: "220px" }}>
      {/* Header */}
      <div
      ...
      {/* Add todo */}
      <div className="px-2 py-2" style={{ borderBottom: "1px solid var(--ide-border)" }}>
      ...
      {/* Import context */}
      <div className="px-2 py-1" style={{ borderBottom: "1px solid var(--ide-border)" }}>
      ...
      <div className="flex-1 overflow-y-auto px-2 py-1">
        {isLoading ? (
          ...
          <div className="py-6 text-center" style={{ opacity: 0.3 }}>
            <span style={{ fontFamily: "var(--font-content)", fontSize: "11px", color: "var(--ide-text)" }}>
              No notes yet
            </span>
          </div>
        ) : (
          <>
              ...
              >
                <button
                  ...
                  style={{
                    ...
                    height: "14px",
                    borderRadius: "3px",
                    border: `1.5px solid ${todo.status === "in_progress" ? "#043B40" : "var(--ide-border)"}`,
            ...
            {/* Done section */}
            {done.length > 0 && (
              <div className="mt-2 pt-2" style={{ borderTop: "1px solid var(--ide-border)" }}>
