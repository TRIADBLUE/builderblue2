...
function MiniTreeItem({ node, depth }: { node: TreeNode; depth: number }) {
  ...
  return (
    <div>
      ...
      >
        {node.isDir ? (
          <span style={{ fontSize: "10px", color: "var(--ide-text-dim)", width: "12px" }}>{open ? "▾" : "▸"}</span>
        ) : (
        ...
        <span style={{
          ...
          fontSize: "13px",
          color: node.isDir ? "var(--ide-text)" : "var(--ide-text)",
  ...
  return (
    <div className="h-full overflow-y-auto glass-bg" style={{ background: "transparent" }}>
      <div style={{ maxWidth: "480px", margin: "0 auto", padding: "24px 20px" }}>
        ...
        {/* Divider */}
        <div style={{ height: "1px", background: "var(--ide-border)", marginBottom: "24px" }} />
        ...
        <div style={{ marginBottom: "32px" }}>
              ...
              {designFiles.map((df, i) => (
                <div key={i} style={{ position: "relative" }}>
                  <img
                    src={df.url}
                    alt={df.name}
                    style={{ width: "64px", height: "64px", objectFit: "cover", borderRadius: "6px", border: "1px solid var(--ide-border)" }}
                  />
                  <button
                  ...
                  <div style={{ fontFamily: "var(--font-content)", fontSize: "9px", color: "var(--ide-text-muted)", textAlign: "center", marginTop: "2px", maxWidth: "64px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                    {df.name}
                  </div>
                </div>
              ))}
          ...
          >
            <div>
              <div style={{ fontFamily: "var(--font-content)", fontSize: "14px", fontWeight: 600, color: "var(--ide-text)" }}>
                Figma Import
              </div>
